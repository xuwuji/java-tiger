...
CREATE TABLE news (id int NOT NULL AUTO_INCREMENT PRIMARY KEY , title VARCHAR(255), link VARCHAR(255), time  VARCHAR(255),content longtext,commentNum int, typeId int )ENGINE=InnoDB DEFAULT CHARACTER SET=gb2312;
