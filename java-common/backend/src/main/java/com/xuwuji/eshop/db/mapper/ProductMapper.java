...
public interface ProductMapper {
	...
	public void disableGift(HashMap<String, Object> map);

	public void enableGift(HashMap<String, Object> map);
	...
	public List<Product> getActiveGift(HashMap<String, Object> map);
}
