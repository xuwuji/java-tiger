		...
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				<div class="modal-header">
					...
					<h4 class="modal-title" id="myModalLabel">新增一个banner项</h4>
				</div>
				<div class="modal-body">
					...
					<div class="form-group">
						<label for="txt_departmentname">跳转页面</label> <input type="text"
							name="txt_departmentname" data-bind="value:Name"
							class="form-control" id="add-redirectUrl" placeholder="跳转页面">
					</div>
					<div class="form-group">
		...
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				...
				<div class="form-group">
					<label for="txt_departmentname">跳转页面</label> <input type="text"
						name="txt_departmentname" data-bind="value:Name"
						class="form-control" id="edit-redirectUrl" placeholder="跳转页面">
				</div>
				<div class="form-group">
					<label for="txt_departmentname">banner位</label> <input type="text"
						name="txt_departmentname" data-bind="value:Name"
...
<script>
	...
	$table.bootstrapTable({
		url : '/backend/admin/banner/getAll', //请求后台的URL（*）
		method : 'get', //请求方式（*）
